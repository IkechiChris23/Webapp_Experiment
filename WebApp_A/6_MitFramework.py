...
PROMPTS_CONFIG = {
    "problem_space": [
        ...
        "Hinterfrage meine Annahmen: Sind meine gesetzen Bedingungen und der Fokus realistisch für diese Situation?",
    ...
    "ideation_space": [
        ...
        "Wie kann ich meine Gedanken aus z.B. dem Knowledge Space weiter ausbaueen, um einen einen präziseren Ansatz zu formulieren?",

        "Entwickle eine neue Möglichkeit, indem du zwei bestehende Elemente kombinierst.",
     
        "Entwickle eine Verändeung des Falls, die eine bessere Nutzung erlaubt.",
