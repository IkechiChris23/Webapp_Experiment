...
if st.session_state.get("round_1_completed_export", False):
    ...
    # Process Round 1 (Ohne Framework) data
    ...
    process_entries(ohne_p, "Ohne Framework", first_case)
    process_entries(ohne_k, "Ohne Framework", first_case)
    process_entries(ohne_i, "Ohne Framework", first_case)
    ...
    if st.button("Weiter zu Runde 2", use_container_width=True):
        ...
        # Reset MIT state variables in case MIT is the second round
